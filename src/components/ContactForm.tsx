    ...
    <section className="py-5 bg-white" id="contact">
      <div className="container" style={{ maxWidth: "700px" }}>
        ...
        <div className="card shadow-sm border-0 rounded-4 p-4 p-md-5">
          {status === "success" && (
            <div
              className="alert alert-success d-flex align-items-center fw-medium border-0 shadow-sm mb-4"
              role="alert"
            >
              <svg
          ...
          {status === "error" && (
            <div
              className="alert alert-danger d-flex align-items-center fw-medium border-0 shadow-sm mb-4"
              role="alert"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
